...
export default function TrialPopup() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 w-[92vw] max-w-sm">
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_20px_70px_rgba(2,6,23,0.18)]">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <Link
            href="/app"
            className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:border-slate-300"
          >
            Keep using free
          </Link>
        </div>
