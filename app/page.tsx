    ...
    <main className="mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-slate-500">
              Free to try • No watermark • Download instantly
            </p>
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-2">
              <IconBullet
                ...
                desc="Your results look professional and ready to use in real designs."
              />
              <IconBullet
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 max-w-3xl text-sm text-slate-600">
          CleanCut AI fits naturally into your workflow, whether you sell, create,
          or design.
        </p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          ...
          <PersonaCard
            ...
            bullets={[
              "Transparent assets for campaigns",
